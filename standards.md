...
Below is an example of a section written in accordance with these standards:
...
3. Playing a card costs Card Energy equal to the card’s Count (see Article 10, §10.2.1).
4. Playing a card consumes zero (0) Ticks.
```

## 9. Application for LLMs

When an LLM is instructed to produce a rules document in this legalistic style, it shall:
...
These standards shall be applied to all future game rules expansions, card definitions, and scenario documents to ensure a uniform legalistic style.

## 10. Audits and Pending Items

### 10.1 – Regular Audits

Every major subsystem (e.g., Arcana, Domains, Buildings) shall be audited for integration with the full rules at least once before final publication. Audits shall follow the format established in the Fool Arcana audit, identifying:
...
1. Create a **master document** (e.g., `tarot.md`) that contains:
...
Sub‑documents may include a “Summary of Relevant Core Rules” section to restate such essentials without reproducing the entire core document.
