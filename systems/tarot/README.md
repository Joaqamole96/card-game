...
|-----------|---------------------------------------------------------------------------------|-----------------------------------------------------|
| Swords    | Conflict and control: attacks, defenses, imposing justice.                      | Pacification, disarmament, vulnerability, weakening offensive capabilities. |
| Wands     | Conquest and prosperity: spreading religion, miracles, curses, omens, passion, silencing sedition. | Decline, stagnation, failed expansions, religious backfire. |
| Cups      | Harmony and restoration: building relationships, calming unrest, boosting morale, fostering unity and leisure. | Discord, unrest, demoralization, social fracture.   |
| Pentacles | Abundance and stability: accumulating resources, building structures, enabling trade, funding expenses and tragedy. | Scarcity, decay, trade disruption, resource drain.  |
