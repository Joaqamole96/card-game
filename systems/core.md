...
This document is part of the Game Rules. It defines the fundamental structure of turns, time, and card play.
...
## ARTICLE 12 – CARD COST

*Note: This article is placed here for convenience. The authoritative version is in the Tarot Master Document, but repeated for redundancy.*

### §12.1 – Energy Cost

Playing a card requires expenditure of Card Energy equal to the card’s Count (Tarot Master Document, §3.2.1).
...
## ARTICLE 13 – SUIT FOCUS (IN‑GAME TOGGLE)

### §13.1 – Declaration

At the start of the Draw Phase, a Player may select any non‑empty subset of the four suits to be **active**.

### §13.2 – Drawing Restriction
